                        ...
                        <div class="row">
                                ...
                                <form method="GET" action="{{url('search')}}">
                                    <div class="top-search header-search-form mbt-25">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control search-live live-search_focused" id="search-input" name="s" value="{{htmlentities(_get('s'))}}" placeholder="Nhập từ khóa..." aria-label="Search for...">
                            ...
                            <div class="col-4 col-sm-3">
                                <div class="mbt-25">
                                    ...
                                    <a href="@home_url('cart')" class="btn btn-warning"><i class="fa fa-shopping-cart"></i> Giỏ hàng (<span class="cart-item-total">{{$cart->count()}}</span>)</a>
                                </div>
