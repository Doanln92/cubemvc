<?php try{ ?>        <footer>
            <div class="container">
                ...
                <?php $Cat = get_model('Category'); ?>
                <?php $categoryes = $Cat::where('parent_id','')->get(); ?>
                <?php if(is_array($categoryes) && count($categoryes) > 0) foreach($categoryes as $cat){ ?>
                    
                    <div class="col-4 col-sm-3 col-lg-2">
                        <ul>
                            <li class="big-cate"><a href="<?php echoif($cat->getUrl()); ?>"><?php echoif($cat->name); ?></a></li>
                            <?php if($ch = $cat->getChildren()){ ?>
                                <?php foreach($ch as $c){ ?>
                            
                                <li><a href="<?php echoif($c->getUrl()); ?>"><?php echoif($c->name); ?></a></li>
                ...
                <div class="footer-boxes row">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="cube-box-area subcribe">
                            ...
                            <div class="cube-box-content">
                                <form action="<?php echoif(url('subcribe')); ?>" method="POST" id='footer-subcribe'>
                ...
                <div class="copy row">
                    ...
                    <div class="col-12 col-sm-5 col-lg-2">
                        <a href="<?php home_url(); ?>">
                            <img src="<?php public_url('images/logo.png'); ?>" alt="">
                        </a>
                    </div>
        ...
        </footer><?php return true; }catch(CubeException $e){return $e;}catch(Exception $e){return $e;} ?>