...
class Str{
    ...
    protected function setUnicodeArr(){
        ...
        if($arr = App::data()->json('language/str')){
    ...
    function getNamespace($str){
        ...
        $f = '/([^A-z0-9_\-]|^\-|\-$)/';
        $r = '';
        $str = str_replace($p, $q, $this->vi2en($str));
        $str = preg_replace($f, $r, $str);
        $str = preg_replace($f, $r, $str);
    ...
    function getNamespace2($str=null){
        $p = array(". ", ".", ", ", ",", " & ", " ", "&", "=");
        $q = array("_", "_", "_", "_", "_", "_", "_", "_");
        $f = '/([^A-z0-9_]|^_|_$)/';
        $r = '';
        $str = preg_replace('/(___|__)/', '_', preg_replace($f, $r, str_replace($p, $q, $this->vi2en($str))));
        $str = preg_replace('/[\\\"\']/', '', $str);
        $str = preg_replace($f, $r, $str);
        return $str;
    }
    function getAccessName($str=null){
        $p = array(". ", ".", ", ", ",", " & ", " ", "&", "=");
        $q = array("_", "_", "_", "_", "_", "_", "_", "_");
        $f = '/([^A-z0-9_]|^_|_$)/';
        $r = '';
    ...
    function sclr($str=null,$char=null){
        $st = $this->vi2js($str);
    ...
    function wspl($str=null, $start = 0, $length = 1000000){
    ...
    function subword($str=null, $start = 0, $length = 50000,$moretext='',$keepline=false){
    ...
    function subtext($str=null, $start = 0, $length = "MAX"){
